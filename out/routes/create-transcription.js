...
function createTranscriptionRoute(app) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            app.get('/videos/:videoId/transcription', function (req) { return __awaiter(_this, void 0, void 0, function () {
                var paramsSchema, videoId, bodySchema, prompt;
                return __generator(this, function (_a) {
                    paramsSchema = zod_1.z.object({
                        videoId: zod_1.z.string().uuid(),
                    });
                    videoId = paramsSchema.parse(req.params).videoId;
                    bodySchema = zod_1.z.object({
                        prompt: zod_1.z.string()
                    });
                    prompt = bodySchema.parse(req.body).prompt;
                    return [2 /*return*/, {
                            videoId: videoId,
                            prompt: prompt,
                        }];
